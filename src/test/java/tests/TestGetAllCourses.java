...
//                RestAssured.given().expect().defaultParser(Parser.JSON).when().get("https://www.rahulshettyacademy.com/api/course").as(AllCourses.class);
        AllCourses allCourses =
                RequestBuilder.performRequest("https://www.rahulshettyacademy.com", null, "/tests/course", null, RequestMethod.GET, null, null, null, HttpStatus.SC_OK, true, ContentType.JSON).as(AllCourses.class);
