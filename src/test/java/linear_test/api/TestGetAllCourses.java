...
//                RestAssured.given().expect().defaultParser(Parser.JSON).when().get("https://www.rahulshettyacademy.com/api/course").as(AllCourses.class);
        AllCourses allCourses =
                RequestBuilder.performRequest("https://www.rahulshettyacademy.com", null, "/api/course", null, RequestMethod.GET, null, null, null, ContentType.JSON, HttpStatus.SC_OK).as(AllCourses.class);
